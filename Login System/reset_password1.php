...
<header>
    ...
    <nav style="background-color:#FFC145 ;">
        <div class="nav-section-a">
            <a href="bookingform.php">Booking Appointment</a>
            <a href="doctors profile.html">Doctor Profile</a>
            <a href="common diseases.html">Common Disease</a>
        </div>
        <div class="nav-section-b">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-content">
                    ...
                    <li><a href="../About Us/Mission&Vision1">Vision & Mission</a></li>
                    <li><a href="../Newsboard/newsboardUser1.html">News Board</a></li>
                    <li><a href="../Survey/survey.html">Survey</a></li>
                </ul>
            </div>
            <div class="dropdown">
                    <a href="ContactUs1.html" class="dropdown-word">Contact Us</a>
                </div>
            <div class="dropdown">
    ...
    <section class="login-form">
        <?php if (!empty($message)): ?>
            ...
            <?php if ($message === "Passwords do not match."): ?>
                <br>
                <a href="../Login System/reset_password1.php">Go back to reset password page</a>
            <?php endif; ?>
        <?php else: ?>
